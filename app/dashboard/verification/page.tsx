...
function creatorSteps(userEmail: string, creator: CreatorCardData | null): VerificationStep[] {
...
function brandSteps(userEmail: string, brand: BrandProfileData | null): VerificationStep[] {
        ...
        <main className="bridge-section max-w-5xl py-8 sm:py-10">
          ...
          <div className="grid gap-6 lg:grid-cols-[1fr_390px]">
            <ProgressPanel
              ...
              steps={creatorSteps(user.email, creator)}
              code={code}
      ...
      <main className="bridge-section max-w-5xl py-8 sm:py-10">
        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_390px]">
          <ProgressPanel
            ...
            steps={brandSteps(user.email, brand)}
          >
