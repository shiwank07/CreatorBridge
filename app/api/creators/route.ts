...
export async function GET(req: Request) {
  ...
  const result = await getCreatorDiscoveryPage({
    ...
    primaryPlatform: url.searchParams.get("primaryPlatform") ?? undefined,
    verifiedPlatformOnly: url.searchParams.get("verifiedPlatform") === "true",
    foundingOnly: url.searchParams.get("founding") === "true",
    verifiedAudienceRange: url.searchParams.get("verifiedAudience") ?? undefined,
