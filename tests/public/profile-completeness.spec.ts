...
test("public creator profile omits empty collaboration history instead of rendering pending stats", () => expect(creatorPage).toContain("historySummary.completed > 0 ? <WorkingHistoryCard"));
